...
contract AlligatorOPV4Test is AlligatorOPTest {
    ...
    // // This test works but it's wrong, auto-standard vote is not compatible with alligator V4.
    // function testCastVoteTwice() public virtual {
    //     address proxy = AlligatorOPV4(alligator).proxyAddress(Utils.alice);
    ...
    //     assertEq(forVotes, 50e18 + op.getVotes(proxy));
    ...
    //     assertEq(forVotes, 75e18 + op.getVotes(proxy));
    // }
